...
def charLength(string):
    ...
    if string_len > 10:
        print(f"The string {string} has more than 10 characters.")
    elif string_len > 5:
        print(f"The string {string} has more than 5 characters.")
    else:
        print(f"The string {string} only has {string_len} characters.")
charLength(stringy1)
charLength(stringy2)
charLength(stringy3)
