...
for city in check_cities1:
    if city in cities:
        print(f"The city {city} exists in our dictionary.")
    else:
        print(f"The city {city} does not exist in our dictionary.")
...
for city in check_cities2:
    if city not in cities:
        print(f"This city does not exist in the dictionary.")
